...
- 호텔에 남는 [2인용](인원) [객실](객실) 있나요?
- [2인실](객실종류)에 [3명](인원)이 함께 묵을 수 있나요?
- 한 객실에 [몇 명](인원)까지 숙박 가능한가요?
...
- [스위트방](객실종류)으로 예약 해주실래요?
- [삼월 이십일](날짜) 예약 가능한가요?
- [다음 주](시간표현)에 숙박하려고 하는데 예약 가능한가요?
- [사월 이십칠일](날짜)에 가려고 하거든요?
- [오늘](시간표현) 숙박 가능한가요?
- [오늘](시간표현) [온돌방](객실종류)으로 예약 되나요?
- [디럭스룸](객실종류) [조식](식사) 포함 [방](객실)으로 주실래요?
- 총 [31명](인원)이 묵을 예정인데, 예약 가능한가요?
- 이 [방](객실)으로 예약 되나요?
- 숙박 예약을 하려는데, 되나요?
...
## intent:호텔-예약확인문의
<!-- - 일주일 전에 호텔 앱으로 분명히 결제했는데, 왜 확인이 안되나요?
...
- [정우성](이름) 이름으로 페밀리룸 [1박](기간) 예약했는데요, 몇호실인가요?
...
## intent:호텔-체크인문의
- 예약한 방 지금 들어갈 수 있을까요?
<!-- - [호텔스닷컴](호텔예약서비스)에서 예약하고 왔어요 -->
<!-- - [오늘부터 2일](기간) 예약 했는데, 확인해주실래요? -->
- 체크인 부탁드려요
...
<!-- - 예약했는데 확인 좀 해주실래요?
- 예약하고 왔는데, 확인되나요? -->
<!-- - [정우성](이름) 이름으로 [패밀리룸](객실종류) [1박](기간) 예약했는데요 -->
- 체크인하려고요
...
- 네, [방](객실) [하나](수량) 예약하려고요
- [트윈룸](객실종류)으로 주시고 선택 가능하면 [샤워 부스](비치품목) 있는 욕실로 주세요
- [패밀리룸](객실종류)이요
- [오션뷰](뷰종류)로 해주세요
- 네, [객실](객실) [하나](수량)면 돼요
...
- [다음 주](시간표현) [금요일](요일)부터 [월요일](요일)까지요
...
- 네 맞습니다
- 맞습니다
- 네, 거기에 [조식](식사) [뷔페](부대시설)까지 같이 결제했어요
- 확실히 패키지로 같이 결제했어요 -->
...
## intent:inform-지역문의
- [제주도](지명)에 [당일](시간표현) 예약 가능한 호텔로 봐 주세요

## intent:inform-추가사항문의
- [침구](비치품목) [3세트](수량) 추가해주세요
- [조식](식사)도 같이 포함해주세요
- 네 추가해 주세요
...
<!-- 한글은 더 다양하게 할 필요있음. -->
## regex:휴대폰번호
- 01[0-9]{8,9} <!-- 01012345678, 0161234567 -->
- 01[0-9]-[0-9]{3,4}-[0-9]{4} <!-- 010-1234-5678, 016-123-4567 -->
